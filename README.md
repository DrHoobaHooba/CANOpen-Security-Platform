...
Examples of reportable anomalies include unexpected reboot/reset, heartbeat loss/timeouts,
invalid state transitions, communication lockups, and unsafe protocol behavior.
